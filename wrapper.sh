#!/bin/bash
#
# ParsingPeas Wrapper Script - Linux Version
# Runs linpeas and automatically sends output to Kali host
...
# Hardcoded for Linux - no OS detection needed
SCAN_TYPE="linpeas"
echo "[*] Target: Linux/Unix system"
